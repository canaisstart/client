...
const AboutUs = () => (
  <Base>
    ...
    <S.SectionNews>
      ...
      <S.Text>
        Esta Política de Privacidade deixa claro o compromisso do Nibo em
        garantir a proteção dos dados pessoais de seus clientes, usuários,
        fornecedores e demais pessoas que interagem com a Plataforma Nibo e seus
        produtos, em quaisquer operações que envolvam o tratamento de dados
      ...
      <S.Text>
        O Nibo adota proteções e medidas para resguardar toda a informação
        imputada em seus sistemas e produtos, utilizando mecanismos de segurança
        da informação eficazes.
      </S.Text>

      <S.Text>
        O Nibo coleta e, em alguns casos, pode revelar informações de seus
        ...
        promocionais do Nibo, de seus produtos, módulos e/ou da Plataforma Nibo
        como um todo.
      </S.Text>
      ...
      <S.Text>
        ...
        que tenham acesso ao espaço digital (site) do Nibo. Para navegar em
        áreas restritas dos sites do Nibo e ter acesso a serviços exclusivos é
        necessário se cadastrar na Plataforma. A presente Política integra os
        Termos de Uso dos recursos da Plataforma Nibo. disponíveis em
        https://www.nibo.com.br/termos-de-uso/ (“Termos de Uso”).
      </S.Text>
      ...
      <S.Text>
        ...
        aplicativos ou outros recursos que não são do Nibo. A ativação desses
        recursos fará com que outras organizações além do Nibo processem
